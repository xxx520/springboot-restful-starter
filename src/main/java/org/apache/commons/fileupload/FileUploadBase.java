...
public abstract class FileUploadBase {
     ...
     * @throws FileUploadException
     */
    public List<FileItem> parseRequest_New(HttpServletRequest request,IoCallback callback
    			,OutputStream out)
            throws FileUploadException {
            ...
            while (iter.hasNext()) {
                ...
                try {
                	...
                	if(!fileItem.isFormField()){
                		//write //TODO ,injection an object will throw Exception
                		//
                		//callback.excute(item.openStream(), out);
                		execute(item.openStream(),out);
                	}else{
                		Streams.copy(item.openStream(), fileItem.getOutputStream(), true);
                	}
                } catch (FileUploadIOException e) {
    ...
    private void execute(InputStream in, OutputStream out) {
    	try {
